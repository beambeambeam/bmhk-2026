export const PAST_INTRO = {
   ...
   */
  paragraphs: [
    "โครงการนี้เปิดโอกาสให้นักเรียนระดับมัธยมศึกษาตอนปลาย ปวช. หรือเทียบเท่า เข้าร่วมการแข่งขันเขียนโปรแกรมด้วยภาษา C/C++ ในรูปแบบทีม" +
      " เพื่อเสริมสร้างทักษะการเขียนโปรแกรม การทำงานร่วมกัน และการแก้ไขปัญหาภายใต้เงื่อนไขเวลาที่กำหนด พร้อมชิงเงินรางวัลรวมกว่า 60,000 บาท",
    "ภาควิชาวิศวกรรมคอมพิวเตอร์ คณะวิศวกรรมศาสตร์ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี เล็งเห็นว่าการเตรียมความพร้อมของนักเรียนระดับมัธยมศึกษา" +
      "ตอนปลายจำเป็นต้องอาศัยการพัฒนาทักษะในด้านต่าง ๆ อย่างต่อเนื่อง เพื่อให้ผู้เข้าแข่งขันได้รับประสบการณ์จริง ตระหนักถึงศักยภาพของตนเอง" +
      " และใช้เป็นแนวทางประกอบการตัดสินใจศึกษาต่อในระดับอุดมศึกษา โดยทีมที่ได้รับรางวัลชนะเลิศถึงรองชนะเลิศอันดับ 2 จะได้รับการพิจารณาเป็นพิเศษ" +
      "ในการสอบสัมภาษณ์เข้าศึกษาต่อในภาควิชาที่กำหนด ของคณะวิศวกรรมศาสตร์ มจธ. ตามเงื่อนไขการรับเข้าศึกษาของแต่ละปีการศึกษา",
  ],
