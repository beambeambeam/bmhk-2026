...
export const SCOPE_CARDS: ScopeCard[] = [
  {
    art: MATH_ART,
    body: "ครอบคลุมคณิตศาสตร์เชิงจำนวนและโครงสร้างเชิงตรรกะ ซึ่งเป็นพื้นฐานของการออกแบบวิธีแก้ปัญหาอย่างมีประสิทธิภาพ",
    count: 2,
  ...
  {
    art: CS_ART,
    body: "ครอบคลุมพื้นฐานการเขียนโปรแกรมภาษา C/C++ การจัดการข้อมูลนำเข้าและส่งออก และโครงสร้างข้อมูลเบื้องต้น",
    count: 4,
  ...
  {
    art: ALGO_ART,
    body: "ครอบคลุมการวิเคราะห์ความซับซ้อน การออกแบบอัลกอริทึม และเทคนิคการแก้ปัญหาที่ใช้ในการแข่งขัน",
    count: 3,
...
export const FAQS = [
  ...
  {
    a: "ใช้ภาษา C และ C++ เท่านั้น ผ่านแพลตฟอร์ม Codern",
    q: "การแข่งขันใช้ภาษาโปรแกรมใดได้บ้าง",
  },
  {
    a: "รอบคัดเลือกจัดในรูปแบบออนไลน์ ส่วนรอบชิงชนะเลิศจัดในรูปแบบ Onsite ณ ภาควิชาวิศวกรรมคอมพิวเตอร์ คณะวิศวกรรมศาสตร์ มจธ.",
    q: "การแข่งขันแต่ละรอบจัดขึ้นในรูปแบบใด",
  },
];
