...
export const TIMELINE_STEPS = [
  ...
  {
    date: "9 พ.ย.",
    lines: ["การแข่งขันรองชนะเลิศและรอบชิงชนะเลิศ", "รูปแบบ Onsite ณ มจธ."],
  },
];
...
export const PRIZES = [
  {
    body: "เงินรางวัล 30,000 บาท พร้อมโล่เกียรติคุณ",
    image: "/assets/prizes/1st.webp",
    title: "รางวัลชนะเลิศ",
  },
  {
    body: "เงินรางวัล 15,000 บาท พร้อมโล่เกียรติคุณ",
    image: "/assets/prizes/2nd.webp",
    title: "รางวัลรองชนะเลิศอันดับ 1",
  },
  {
    body: "เงินรางวัล 10,000 บาท พร้อมโล่เกียรติคุณ",
    image: "/assets/prizes/3rd.webp",
    title: "รางวัลรองชนะเลิศอันดับ 2",
  },
  {
    body: "เงินรางวัล 2,500 บาท พร้อมประกาศนียบัตร",
    image: "/assets/prizes/hm.webp",
    title: "รางวัลชมเชย",
  },
];
...
export const PRIZES_DESCRIPTION =
  "ทีมที่ได้รับรางวัลชนะเลิศถึงรองชนะเลิศอันดับ 2 จะได้รับการพิจารณาเป็นพิเศษในการสอบสัมภาษณ์เข้าศึกษาต่อในภาควิชาที่กำหนดของคณะวิศวกรรมศาสตร์ มจธ. ตามเงื่อนไขการรับเข้าศึกษาของแต่ละปีการศึกษา";
