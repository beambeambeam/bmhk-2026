...
function createUploadProcedure(protectedProcedure: ProtectedProcedure, repository: FileRepository) {
...
function createGetProcedure(protectedProcedure: ProtectedProcedure, repository: FileRepository) {
  return protectedProcedure
    .input(fileIdSchema)
...
export function createFilesRouter(
  ...
  return {
    get: createGetProcedure(protectedProcedure, repository),
    upload: createUploadProcedure(protectedProcedure, repository),
  };
}
